...
| <a name="input_extra_asg_permissions"></a> [extra\_asg\_permissions](#input\_extra\_asg\_permissions) | A JSON with a permissions policy document. The policy will be attached to the ASG instance profile. | `string` | `null` | no |
